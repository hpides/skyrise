...
ExportFormat CompilationContext::GetExportFormat() const { return target_format_; }

void CompilationContext::SetExportFormat(const ExportFormat target_format) { target_format_ = target_format; }

std::string CompilationContext::ExportFileExtension() const {
  switch (target_format_) {
    case ExportFormat::kOrc:
      return std::string{kOrcExtension};
    case ExportFormat::kCsv:
      return std::string{kCsvExtension};
    default:
