...
class CompilationContext {
 public:
  ...
  void SetExportFormat(const ExportFormat target_format);
 ...
 private:
  ...
  ExportFormat target_format_ = kFinalResultsExportFormat;
  size_t max_worker_count_per_pipeline_ = kMaxWorkerCountPerPipeline;
