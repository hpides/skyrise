...
class FilterOperatorProxy : public EnableMakeForPlanNode<FilterOperatorProxy, AbstractOperatorProxy>,
                            public AbstractOperatorProxy {
 public:
  explicit FilterOperatorProxy(std::shared_ptr<AbstractExpression> predicate);
