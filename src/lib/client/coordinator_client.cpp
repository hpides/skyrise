...
CoordinatorClient::CoordinatorClient() {
  ...
  const std::vector<std::function<void()>> initializers{
      ...
      [&]() {
        mutable_s3_client_ =
            std::make_shared<Aws::S3::S3Client>(credentials_provider, s3_endpoint_provider, client_configuration);
      },
  };
...
std::shared_ptr<Aws::S3::S3Client> CoordinatorClient::GetMutableS3Client() { return mutable_s3_client_; }
