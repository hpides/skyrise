...
const boost::bimap<AggregateFunction, std::string> kAggregateFunctionToString =
    MakeBimap<AggregateFunction, std::string>({
        {AggregateFunction::kAny, "ANY"},
...
const boost::bimap<ExchangeStrategyType, std::string> kExchangeStrategyTypeToString = MakeBimap<ExchangeStrategyType, std::string>({
