...
class ManifestWriter : OrcFormatWriter {
 public:
  ...
  void SetSchema(std::shared_ptr<const TableColumnDefinitions> partition_schema);
 ...
 private:
  ...
  std::shared_ptr<const TableColumnDefinitions> partition_schema_;
