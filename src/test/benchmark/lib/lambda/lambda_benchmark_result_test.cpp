...
TEST(LambdaBenchmarkResultTest, InvokeResultAndLogResult) {
  LambdaInvokeResult invoke_result_0("0");
  ...
  LambdaInvokeResult invoke_result_1("1");
  ...
  // We have to use a raw pointer here as the LambdaInvokeResult's ResponseStream will take ownership of this stream
