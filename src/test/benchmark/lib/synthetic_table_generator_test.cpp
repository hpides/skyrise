...
TEST(SyntheticTableGeneratorTest, TestGeneratedValueRange) {
  ...
  const auto uniform_distribution_0_1 = ColumnDataDistribution::MakeUniformConfig(0.0, 1.0);

  const auto table = table_generator->GenerateTable({ColumnSpecification(uniform_distribution_0_1, DataType::kDouble)},
