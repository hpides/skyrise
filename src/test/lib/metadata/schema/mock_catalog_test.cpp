...
TEST_F(MockCatalogTest, AddTableSchemaFromFileHeader) {
  mock_catalog_.AddTableSchemaFromFileHeader("int_string", "resources/test/tbl/int_string.tbl");
  mock_catalog_.AddTableSchemaFromFileHeader("int_int_int", "resources/test/tbl/int_int_int.tbl");
