...
TEST_F(MockNodeTest, UniqueConstraints) {
  ...
  const TableKeyConstraints table_key_constraints = {key_constraint_a_b, key_constraint_c};
  mock_node_a_->SetKeyConstraints(table_key_constraints);
...
TEST_F(MockNodeTest, UniqueConstraintsPrunedColumns) {
  ...
  const TableKeyConstraint key_constraint_c({ColumnId{2}}, KeyConstraintType::kUnique);
  mock_node_a_->SetKeyConstraints({key_constraint_a, key_constraint_a_b, key_constraint_c});
