...
TYPED_TEST(FormatReaderTest, UnexpectedSchema) {
  ...
  const auto reader = BuildFormatReader<Reader>(
      this->test_data_storage_, this->file_format_ + "/timestamp_date_bool_varchar." + this->file_format_, options);
...
TYPED_TEST(FormatReaderTest, DateAsNumericValue) {
  ...
  const auto reader = BuildFormatReader<Reader>(
      this->test_data_storage_, this->file_format_ + "/timestamp_date_bool_varchar." + this->file_format_);
...
TYPED_TEST(FormatReaderTest, UnsupportedTypes) {
  ...
  const auto reader = BuildFormatReader<Reader>(this->test_data_storage_,
                                                this->file_format_ + "/unsupported_array." + this->file_format_);
