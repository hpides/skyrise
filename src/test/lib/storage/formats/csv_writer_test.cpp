...
TEST_F(CsvFormatWriterTest, FloatingPointPrecision) {
  ...
  schema_floating_points.push_back(TableColumnDefinition("test_float", DataType::kFloat, false));
  schema_floating_points.push_back(TableColumnDefinition("test_double", DataType::kDouble, false));
