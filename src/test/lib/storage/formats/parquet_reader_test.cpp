...
TEST_F(ParquetFormatReaderTest, ArrowPredicatePushdown) {
  ...
  auto parquet_reader =
      BuildFormatReader<ParquetFormatReader>(test_storage_, "parquet/partitioned_int_string.parquet", parquet_options);
...
TEST_F(ParquetFormatReaderTest, ProjectionPushdown) {
  ...
  auto parquet_reader_projection = BuildFormatReader<ParquetFormatReader>(
      test_storage_, "parquet/partitioned_int_string.parquet", parquet_options_projection);
...
TEST_F(ParquetFormatReaderTest, ReadInvalidPartition) {
  ...
  auto parquet_reader =
      BuildFormatReader<ParquetFormatReader>(test_storage_, "parquet/with_types.parquet", parquet_options);
