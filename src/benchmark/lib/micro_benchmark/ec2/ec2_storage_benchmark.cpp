      ...
      for (const auto concurrent_instance_count : concurrent_instance_counts) {
        for (const auto storage_type : storage_types) {
          ...
          benchmark_configs_.emplace_back(
              ...
              Ec2StorageBenchmarkParameters{
                  {instance_type, concurrent_instance_count, repetition_count},
                  {object_size_kb, object_count, StorageOperation::kWrite, storage_type, enable_s3_eoz},
                  sqs_queue_urls,
                  repetition_prefixes});
        }
      }
...
Aws::Utils::Json::JsonValue Ec2StorageBenchmark::GenerateResultOutput(const std::shared_ptr<Ec2BenchmarkResult>& result,
  ...
  return Ec2BenchmarkOutput(Name(), parameters.base_parameters, result)
      ...
      .WithDoubleRepetitionMetric([&](const Ec2BenchmarkRepetitionResult& repetition_result) {
        ...
        const double repetition_write_measurement_start_ms = *std::min_element(
            invocation_write_measurement_starts_ms.begin(), invocation_write_measurement_starts_ms.end());
        const double repetition_write_measurement_end_ms =
            *std::max_element(invocation_write_measurement_ends_ms.begin(), invocation_write_measurement_ends_ms.end());
      ...
      .WithDoubleRepetitionMetric([&](const Ec2BenchmarkRepetitionResult& repetition_result) {
        ...
        const double repetition_read_measurement_start_ms = *std::min_element(
        ...
        const double repetition_read_measurement_end_ms =
            *std::max_element(invocation_read_measurement_ends_ms.begin(), invocation_read_measurement_ends_ms.end());
