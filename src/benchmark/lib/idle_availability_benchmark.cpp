...
Aws::Utils::Json::JsonValue IdleAvailabilityBenchmark::GenerateResultOutput(
  ...
  return BenchmarkHelper::GenerateJsonOutput(
      ...
      {{"availability_percentage_average", availability_percentages_aggregates.average},
       ...
       {"availability_percentage_percentile_90", availability_percentages_aggregates.percentile_90},
       {"availability_percentage_percentile_99", availability_percentages_aggregates.percentile_99},
       {"availability_percentage_percentile_99.9", availability_percentages_aggregates.percentile_99_9},
       {"availability_percentage_percentile_99.99", availability_percentages_aggregates.percentile_99_99},
       {"availability_percentage_std_dev", availability_percentages_aggregates.standard_deviation},
       {"unavailable_phases_counts_average", unavailable_phases_counts_aggregates.average},
