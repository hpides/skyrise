  ...
  try {
    ...
    benchmark_registry.RegisterBenchmark(
        ...
        std::make_unique<skyrise::NetworkLatencyBenchmark>(
            benchmark_helper, cost_calculator, std::vector<size_t>{512}, std::vector<size_t>{skyrise::KbToByte(1)},
            std::vector<size_t>{skyrise::KbToByte(1), skyrise::MbToByte(100)}, 100, 10000));
    ...
    benchmark_registry.RegisterBenchmark(
        ...
        std::make_unique<skyrise::NetworkThroughputBenchmark>(
            ...
            std::vector<size_t>{1, 2, 4, 8}, 100, 1000));
    ...
    benchmark_registry.RegisterBenchmark(
        ...
        std::make_unique<skyrise::NetworkThroughputParallelBenchmark>(
            benchmark_helper, cost_calculator, std::vector<size_t>{1, 10, 100, 1000, 10000}, 1, 100));
