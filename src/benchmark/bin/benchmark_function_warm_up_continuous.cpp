...
int main(int argc, char* argv[]) {
  try {
    BenchmarkExecutable executable("skyriseBenchmarkFunctionWarmUpContinuous", "Function Warm Up Continuous Benchmark");
    ...
    auto benchmark = std::make_shared<skyrise::FunctionWarmUpContinuousBenchmark>(
        ...
        parse_result["warm_up_min_intervals"].as<std::vector<size_t>>(), parse_result["repetition_count"].as<size_t>());
