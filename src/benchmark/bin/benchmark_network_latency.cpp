...
int main(int argc, char* argv[]) {
  ...
  try {
    ...
    cxxopts::Options cli_options("skyriseBenchmarkNetworkLatency", "Network Latency Benchmark");
    ...
    cli_options_adder("object_byte_sizes_read", "The read object sizes [B]", cxxopts::value<std::vector<size_t>>());
    cli_options_adder("object_byte_sizes_write", "The write  object sizes [B]", cxxopts::value<std::vector<size_t>>());
    ...
    skyrise::NetworkLatencyBenchmark benchmark(
        benchmark_helper, cost_calculator, {cli_arguments["function_instance_mb_sizes"].as<std::vector<size_t>>()},
        {cli_arguments["object_byte_sizes_read"].as<std::vector<size_t>>()},
        {cli_arguments["object_byte_sizes_write"].as<std::vector<size_t>>()}, cli_arguments["batch_size"].as<size_t>(),
